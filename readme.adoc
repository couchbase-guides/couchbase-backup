...
Add these cbbackupmfg commands to a script that will be automatically run on a schedule (like a https://help.ubuntu.com/community/CronHowto[Cron job] or a link:https://technet.microsoft.com/en-us/library/jj649816(v=wps.630).aspx[Scheduled Task Cmdlet]). You may also want to make ZIP a part of this backup task to save disk space.
